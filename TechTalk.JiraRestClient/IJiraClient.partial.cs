...
namespace TechTalk.JiraRestClient
{
	public partial interface IJiraClient<TIssueFields>
	{
		...
		IEnumerable<Issue<TIssueFields>> GetIssues(IEnumerable<string> projectKeys = null, IEnumerable<string> issueTypes = null, IEnumerable<string> assignees = null, IEnumerable<string> statuses = null, IEnumerable<string> parentIds = null, Func<Issue<TIssueFields>, bool> filter = null);
		...
		/// <summary>Returns a count of all issues of the specified type for the given project</summary>
		int GetIssueCount(string projectKey, IEnumerable<string> issueTypes = null, IEnumerable<string> assignees = null, IEnumerable<string> statuses = null, IEnumerable<string> parentIds = null, Func<Issue<TIssueFields>, bool> filter = null);
		...
		IEnumerable<User> GetUsers(IEnumerable<string> projectKeys);
	}
}
